...
scvi-tools_ (single-cell variational inference tools) is a package for probabilistic modeling of single-cell omics data, made up of two components. First, scvi-tools contains implementations of several models that facilitate a broad number of tasks across many omics, including
